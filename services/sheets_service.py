...
class GoogleSheetsService:
    ...
    def get_monthly_statistics(self, spreadsheet_id: str) -> Dict:
        ...
        try:
            ...
            avg_daily_expense = (
                total_expense / days_in_month if days_in_month > 0 else 0
            )
    ...
    def ensure_summary_sheet(self, spreadsheet_id: str):
                ...
                "setDataValidation": {
                    ...
                    "rule": {
                        "condition": {
                            "type": "ONE_OF_LIST",
                            "values": [
                                {"userEnteredValue": name} for name in month_sheets
                            ],
                        },
                        "showCustomUi": True,
                        "strict": True,
        ...
        summary_values = [
            [
                "Общая сумма доходов",
                '=SUMIF(INDIRECT($E$1&"!B:B"); "Доход"; INDIRECT($E$1&"!D:D"))',
            ],
            [
                "Общая сумма расходов",
                '=SUMIF(INDIRECT($E$1&"!B:B"); "Расход"; INDIRECT($E$1&"!D:D"))',
            ],
            ["Баланс", "=B1-B2"],
